    ...
    return (
        <tr>
            ...
            <td className="py-4 px-6 text-sm font-medium text-center whitespace-nowrap">
                <Link href={`/hmu/${props.hardware.internalId}`} className="p-2 mr-2 rounded-sm border-2 bg-theme-blue bg-opacity-20 border-theme-black text-theme-yellow hover:underline">Edit</Link>
                <Link href={`/hmu/delete/${props.hardware.internalId}`} className="p-2 border-2 bg-theme-blue bg-opacity-20 border-theme-black text-theme-yellow hover:underline">Delete</Link>
            </td>
        </tr>
    )
}
